...
export const fetchData = (query, data) => async () => {
...
export const startLoading = (component, count = 1) =>
  component.setState({ loading: component.state.loading + count })
      ...
      return new Promise((resolve, reject) =>
        p
          ...
          .then((content) => {
            component.setState({
              ...content,
              loading: component.state.loading - 1
            })
            resolve()
          })
      )
