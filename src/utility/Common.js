...
export const getDominancePerc = (score, type='level') => parseFloat(100*score/max_scores[type]).toFixed(2) + '%'

export const calcScore = (rank, player_count, type='level') => 
    max_scores[type]*(0.25 + 0.75*(1.0 - Math.pow((Math.log(rank) / Math.log(player_count)), 2)))
...
export const getRankImage = (name) => ( <img src={'/img/ranks/' + name + '.png'} alt={name} /> )
